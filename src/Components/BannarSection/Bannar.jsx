    ...
    <Swiper
      ...
      >
        <SwiperSlide className=' flex flex-col relative'>
            <img className='rounded-lg absolute w-full min-h-full object-cover -z-20' src="https://i.ibb.co/fQv4czb/impasto-acrylic-painting-fd4bd315-32ad-4fc2-b22f-96f10130deac-1600x.webp" alt="" />

<h2 className='text-3xl mt-20  text-white px-2  py-5 bg-[#0000007b]'>Discover the Beauty of Original Art</h2>
<p className='md:text-base text-xs rounded-b-lg    px-2 py-4 bg-[#ffffffbd] absolute right-0 left-0   bottom-0'>Immerse yourself in the world of art with our handpicked collection of exquisite paintings. Each piece tells a unique story, waiting for you to explore. From vibrant landscapes to thought-provoking abstracts, find the perfect piece to adorn your space</p>
        </SwiperSlide>
        <SwiperSlide className=' flex flex-col relative'>
            <img className=' absolute rounded-lg w-full min-h-full object-cover -z-20' src="https://i.ibb.co/wp2ryMX/malen-kunstkurs.webp" alt="" />

<h2 className='text-3xl mt-20  text-white px-2  py-5 bg-[#0000007b]'>Meet the Artist Behind the Brush</h2>
<p className='md:text-base text-xs  rounded-b-lg px-2 py-4 bg-[#ffffffbd] absolute right-0 left-0   bottom-0'>Get to know the creative genius behind the stunning artworks you love. Our featured artist, brings passion and inspiration to every stroke. Explore their portfolio and delve into the mind of a true master</p>
        </SwiperSlide>
        <SwiperSlide className=' flex flex-col relative'>
            <img className=' absolute rounded-lg w-full min-h-full object-cover -z-20' src="https://i.ibb.co/g9p1Frw/ASF-how-many-images-launch-e1506448264641.jpg" alt="" />

<h2 className='text-3xl mt-20  text-white px-2  py-5 bg-[#0000007b]'>Let Art Transform Your Space</h2>
<p className='md:text-base text-xs rounded-b-lg   px-2 py-4 bg-[#ffffffbd] absolute right-0 left-0   bottom-0'>Elevate your surroundings with the timeless allure of fine art. Whether youre seeking a statement piece for your home or office, our curated collection offers endless possibilities. Experience the transformative power of art and turn your space into a masterpiece.</p>
        </SwiperSlide>
        <SwiperSlide className=' flex flex-col relative'>
            <img className=' absolute w-full rounded-lg min-h-full object-cover -z-20' src="https://i.ibb.co/r4GSyBg/7567073-2x.jpg" alt="" />

<h2 className='text-3xl mt-20  text-white px-2  py-5 bg-[#0000007b]'>Journey Through Time: Unveiling Historical Masterpieces</h2>
<p className='md:text-base text-xs rounded-b-lg   px-2 py-4 bg-[#ffffffbd] absolute right-0 left-0   bottom-0'>Embark on a fascinating exploration of the past through the lens of art. Our collection features timeless masterpieces that capture pivotal moments in history with unparalleled depth and emotion. From majestic portraits of monarchs to vivid depictions of bygone civilizations, each painting tells a rich and captivating story waiting to be discovered</p>
        </SwiperSlide>
