...
const ErrorPage = () => {
    return (
        <div className=" bg-slate-900 h-screen error flex flex-col justify-center gap-10 items-center ">
            ...
            <NavLink to='/'>
            <Button color="secondary" variant="outline" className="head-btn font-light  text-sm md:text-base text-white hover:bg-slate-700  hover:text-slate-100 bg-slate-800">
        Go home
      </Button>
